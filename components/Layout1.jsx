    ...
    return (
        <div className={`${geistSans.className} ${geistMono.className} bg-gradient-to-r bg-white to-yellow-300`} >
            <Head>
                ...
                <meta name="author" content="La Casa del Twingo" />
                <meta name="robots" content="index, follow" />
                  {/* Open Graph para redes sociales */}
                <meta property="og:title" content="La Casa del Twiingo - Repuestos Renault" />
                <meta property="og:description" content="Más que repuestos, una comunidad Renault. Atención personalizada y stock confiable." />
                <meta property="og:image" content="https://casatwingo.vercel.app/logo.jpg" />
                <meta property="og:url" content="https://casatwingo.vercel.app" />
